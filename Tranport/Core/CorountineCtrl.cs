...
{
    public class CoroutineBehaiver:MonoBehaviour
    {
    ...
    public class CoroutineController
    {
        ...
        private static CoroutineBehaiver behaiver;
        public static CoroutineController Instence
        {
            get
            {
                if (_instence == null || behaiver == null || !behaiver.isActiveAndEnabled)
                {
                    behaiver = new GameObject("CoroutineBehaiver", typeof(CoroutineBehaiver)).GetComponent<CoroutineBehaiver>();
                    _instence = new CoroutineController(behaiver);
                }
                return _instence;
            }
        }
